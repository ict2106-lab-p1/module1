...
public static class DataSeeder
{
    ...
    public static void Seed(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Lab>().HasData(
            new Lab { LabId = 1, LabLocation = "NYP-SR7A", LabInCharge = "DefaultAdmin1", LabStatus = "Available", Occupied = 0, Capacity = 25, EnergyUsageBenchmark = 111500 },
            new Lab { LabId = 2, LabLocation = "NYP-SR7B", LabInCharge = "DefaultAdmin1", LabStatus = "Available", Occupied = 0, Capacity = 30, EnergyUsageBenchmark = 111500 },
            new Lab { LabId = 3, LabLocation = "NYP-SR7C", LabInCharge = "DefaultAdmin1", LabStatus = "Available", Occupied = 0, Capacity = 20, EnergyUsageBenchmark = 111500 }
        );
