...
public static class DataSeeder
{
    ...
    public static void Seed(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Accessory>().HasData(
                ...
                new { Id = 2, Name = "Sony A8 IV", Status = "Borrowed", LastUpdated = new DateTime(2021, 10, 14), LabId = 1, AccessoryTypeId = 1, LabUserId = "User1", DueDate = new DateTime(2022, 10, 14), ReviewStatus = "Pending" , ReviewedBy = "David" },
                ...
                new { Id = 5, Name = "DHT22", Status = "Borrowed", LastUpdated = new DateTime(2021, 9, 9), LabId = 1, AccessoryTypeId = 3, LabUserId = "User1", DueDate = new DateTime(2022, 9, 9) , ReviewStatus = "Pending" , ReviewedBy = "David"},
                ...
                new { Id = 8, Name = "LEFO1 LFT2000W", Status = "Borrowed", LastUpdated = new DateTime(2021, 8, 10), LabId = 1, AccessoryTypeId = 4, LabUserId = "User1", DueDate = new DateTime(2022, 9, 5) , ReviewStatus = "Pending" , ReviewedBy = "David"},
                ...
                new { Id = 10, Name = "RM1803", Status = "Borrowed", LastUpdated = new DateTime(2021, 6, 24), LabId = 1, AccessoryTypeId = 5, LabUserId = "User1", DueDate = new DateTime(2022, 10, 14) , ReviewStatus = "Pending" , ReviewedBy = "David"},
                ...
                new { Id = 13, Name = "EDGELEC 4Pin LED Diodes", Status = "Borrowed", LastUpdated = new DateTime(2021, 7, 19), LabId = 1, AccessoryTypeId = 7, LabUserId = "User1", DueDate = new DateTime(2022, 7, 19) , ReviewStatus = "Pending" , ReviewedBy = "David"},
                new { Id = 14, Name = "EDGELEC 6Pin LED Diodes", Status = "Borrowed", LastUpdated = new DateTime(2021, 12, 14), LabId = 1, AccessoryTypeId = 7, LabUserId = "user1", DueDate = new DateTime(2022, 12, 14), ReviewStatus = "Pending" , ReviewedBy = "David" },
