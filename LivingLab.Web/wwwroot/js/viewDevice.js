  ...
  var table = $("#table_id").DataTable({
    ...
    columnDefs: [
      ...
      },
      {
        ...
        defaultContent:
          '<button class=\'hover:bg-sunset-400 font-large rounded-lg text-sm px-5 py-2.5 editBtn\'><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"> <path d="M13.586 3.586a2 2 0 112.828 2.828l-.793.793-2.828-2.828.793-.793zM11.379 5.793L3 14.172V17h2.828l8.38-8.379-2.83-2.828z" /> </svg></button>',
      ...
      },
      {
        ...
        data: null,
        defaultContent:
          '<button class=\'hover:bg-red-300 font-large rounded-lg text-sm px-5 py-2.5 \'><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">\n' +
